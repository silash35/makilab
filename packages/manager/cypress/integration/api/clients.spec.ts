...
describe("Clients API - POST", () => {
  ...
  it("should create a new client and service Order", () => {
    ...
    cy.request({
      ...
      if (!newClient.serviceOrders || !Array.isArray(newClient.serviceOrders)) {
        throw new Error("newClient.serviceOrders should be an array");
      }
  ...
  // TODO: Should fail when invalid necessary values
  // TODO: Should create with correct date values
});
